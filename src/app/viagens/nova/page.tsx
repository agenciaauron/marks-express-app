      ...
      <section className="panel form-panel">
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <label>
              Empresa ou agenciador
              <input placeholder="Ex.: Transportadora X" />
            </label>
            <label>
              Origem
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            <label>
              KM aproximados
              <input inputMode="numeric" placeholder="0 km" />
            </label>
            <label>
              Diesel / despesas da viagem
              <input inputMode="decimal" placeholder="R$ 0,00" />
            </label>
            <label className="full">
              Observações
              <textarea rows={4} placeholder="Alguma informação importante sobre esta viagem..." />
            </label>
          </div>
        </div>
